...
import { Subject, catchError, distinctUntilChanged, map, of, switchMap, takeUntil } from 'rxjs';
...
export class DocumentViewerPageComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    this.route.queryParamMap
      .pipe(
        map((queryParams) => queryParams.get('documentToken')),
